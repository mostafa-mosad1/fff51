            ...
            child: Column(
              ...
              InkWell(
                ...
                decorationColor: Colors.green,decorationThickness: 2,),),
                 trailing: Text("view all...", style: TextStyle(fontSize: 21,color: Colors.deepOrangeAccent)),),
              ),
              Padding(
             ...
             // SizedBox(height: 300,),
              ...
              InkWell(
                child: ListTile(title: Text("service",style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 30,
                  decoration:TextDecoration.underline,
                  decorationColor: Colors.green,decorationThickness: 2,),),
                  trailing: Text("view all...", style: TextStyle(fontSize: 21,color: Colors.deepOrangeAccent)),),
