...
class _cartState extends State<cart> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(child: Scaffold(appBar: AppBar(backgroundColor: Colors.white,shape: RoundedRectangleBorder(borderRadius: BorderRadius.only
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.start,crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ...
                Column(
                    ...
                    children: [ClipRRect(borderRadius: BorderRadius.circular(25),child: Image(image: AssetImage("images/cat.jpg"),width:115,height: 155,fit:BoxFit.cover,))]),
                SizedBox(width: 6,),
                ...
                Column(
                  ...
                  children: [
                    Row(children: [
                      ...
                      }, icon: Icon(Icons.indeterminate_check_box,size: 20,),color: Colors.orangeAccent,),
                      Text("$x"),
                      IconButton(onPressed: (){
                        setState(() {
                          x=x+1;
                        });
                      }, icon: Icon(Icons.add_box,size: 20,),color: Colors.orangeAccent,)
                    ],),
                    Container(decoration: BoxDecoration(
                      borderRadius: BorderRadius.all(Radius.circular(30)),
                      color: Colors.white,
                    ),child: MaterialButton (onPressed: (){}, child: Text("remove",style: TextStyle(color: Colors.red,fontSize: 15),)))
