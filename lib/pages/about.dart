    ...
    return SafeArea(
      child: Scaffold(
          body: Stack(children: [
            ...
            Container(color: Colors.deepOrange,margin: EdgeInsets.only(left: 10,top: 10),
              child: IconButton(onPressed: (){Navigator.pop(context);}, icon:Icon(Icons.arrow_back,size: 30,color: Colors.white,)),
            ),
            SizedBox(height: 20,),
            Center(child: Padding(
              padding: const EdgeInsets.only(top: 30),
              child: Container(width: 350,height: double.infinity,color: Colors.white70,margin: EdgeInsets.only(top: 38),
